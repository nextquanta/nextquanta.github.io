...
<div class="timeline-dot"></div>
<div class="timeline-content">
<span class="date">Dec 2019 &ndash; 2025</span>
<h3>Graduate Research Assistant</h3>
<span class="company">Purdue University | ECE Department</span>
<p>Energy-efficient deep learning, quantum-inspired optimization (FPGA), novel alternatives to backpropagation, binary stochastic neural networks. Advisors: Supriyo Datta & Joseph G. Makin.</p>
</div>
</div>
<div class="timeline-item">
<div class="timeline-dot"></div>
...
<span class="company">Microsoft | Redmond, WA</span>
<p>Formal verification and assertion-based validation of custom AI accelerator architectures.</p>
</div>
</div>
<div class="timeline-item">
<div class="timeline-dot"></div>
<div class="timeline-content">
<span class="date">Aug 2014 &ndash; July 2019</span>
<h3>Senior Design Engineer</h3>
<span class="company">NXP Semiconductors | Noida, India</span>
<p>Test plans and verification environments for DSP, RADAR-based ADAS subsystems, and neural network accelerators. Inventor on US Patent 9,553,594.</p>
</div>
</div>
</div>
